import {SearchRecentProps} from 'src/screens/search/components/SearchRecent';
import {CategoryManga} from 'src/shared/Types';

// TODO Recent count = 4;
export const Recents: SearchRecentProps['recents'] = [
  'search 1',
  'random search 2',
...
export const mostPopularMangaList: CategoryManga[] = [
  {
    id: 15,
